<template>
    ...
    <el-form :model="formData" :rules="rules" ref="formRef" label-width="120px">
        ...
        <el-form-item label="文章摘要" prop="summary">
            <el-input v-model="formData.summary" placeholder="请输入文章摘要（可选）" type="textarea" :rows="4" maxlength="1000" show-word-limit />
        </el-form-item>
        <el-form-item label="标签" prop="tags">
            <el-select v-model="formData.tagArray" placeholder="请输入文章标签（逗号隔开）" multiple filterable allow-create style="width: 100%;">
                <el-option v-for="item in commonTags" :key="item" :value="item" />
            </el-select>
        </el-form-item>
        <el-form-item label="封面图片">
            <div class="cover-upload">
                ...
                <div v-if="imgUrl" class="cover-remove">
                    <el-button type="danger" size="mini" @click="handleRemove">移出封面</el-button>
                </div>
            </div>
        </el-form-item>
