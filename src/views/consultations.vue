<template>
    <div>
        ...
        <el-table :data="tableData" style="width: 100%">
            ...
            <el-table-column prop="lastMessageTime" label="消息时间" width="160" /> 
        ...
        >
            <div class="session-detail">
                ...
                <div class="messages-container">
                    ...
                    <div class="messages-list" :loading="loadingMessages">
                        <div v-for="message in sessionMessages" :key="message.id" class="message-item" :class="message.senderType === 1 ? 'user-message' : 'bot-message'">
